...
describe('DataTable Row Features and Events', () => {
  ...
  test('renders DataTable with various editor types and deep column values', () => {
    ...
    expect(screen.getByText(/Textarea Field/i)).toBeInTheDocument();
    expect(screen.getByText(/Dropdown Field/i)).toBeInTheDocument();
    expect(screen.getByText(/Date Field/i)).toBeInTheDocument();
    expect(screen.getByText(/Date Range Field/i)).toBeInTheDocument();
    expect(screen.getByText(/Radio Field/i)).toBeInTheDocument();
    expect(screen.getByText(/Checkbox Field/i)).toBeInTheDocument();
    expect(screen.getByText(/Switch Field/i)).toBeInTheDocument();
    expect(screen.getByText(/Checkbox Group Field/i)).toBeInTheDocument();
    expect(screen.getByText(/Switch Group Field/i)).toBeInTheDocument();
    expect(screen.getByText(/Radio Group Field/i)).toBeInTheDocument();
  
    // Verify that cell values are rendered.
    expect(screen.getByText(/Text Value/i)).toBeInTheDocument();
    expect(screen.getByText(/Textarea Value/i)).toBeInTheDocument();
    ...
    expect(screen.getByText(/2025-03-10,2025-03-12/i)).toBeInTheDocument();
    // Radio field.
    expect(screen.getByText(/OptionB/i)).toBeInTheDocument();
