...
export const TextInput: React.FC<FormControlProps> = ({
  variant,
  testId,
  ...rest
}) => (
...
export const TextAreaInput: React.FC<FormControlProps> = ({
  variant,
  testId,
  ...rest
}) => <TextArea data-testid={testId} $variant={variant} {...rest} />;

export const CheckboxRadioInput: React.FC<FormControlProps> = ({
  disabled,
  text,
  size,
  testId,
...
export const SwitchInput: React.FC<FormControlProps> = ({
  disabled,
  text,
  size,
  testId,
...
export const SwitchGroup: React.FC<FormControlProps> = ({
  ...
  <GroupControlContainer
    $isVerticalOptions={isVerticalOptions}
    className="group-control-container switch-group"
  >
    {options?.length > 0 ? (
      options.map((option) => (
        <TextContainer key={option.value} disabled={option.disabled}>
...
export const RadioButtonGroup: React.FC<FormControlProps> = ({
  ...
  <GroupControlContainer
    $isVerticalOptions={isVerticalOptions}
    $gap={0}
    className="group-control-container radio-button-group"
  >
    {options?.length > 0 ? (
      options.map((option) => (
