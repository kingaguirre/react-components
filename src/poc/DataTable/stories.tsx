...
const columnSettings: ColumnSetting[] = [
  ...
  { title: "Department", column: "department", sort: "asc", pin: false, editor: {type: "select"} },
  { title: "Salary", column: "salary", sort: "asc", pin: false, editor: {type: "number"} },
  { title: "Working Hours", column: "workingHours", sort: undefined, pin: false, editor: {type: "number-range"} },
  {
    title: "Available",
    column: "active",
    sort: false,
...
export const Demo = {
  ...
  render: () => (
    <StoryWrapper title="DataTable Demo">
      ...
      <DataTable dataSource={sampleData} columnSettings={columnSettings} />
    </StoryWrapper>
  ),
};
